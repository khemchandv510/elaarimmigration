                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="position" class="form-control" placeholder="Category position" value="{{$subCategories->position}}" required />
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Slug  </label>
                                    <input type="text" name="slug" class="form-control" placeholder="Category slug" value="{{$subCategories->slug}}" required />
                                </div>
                            </div>
